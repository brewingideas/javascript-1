...
define({
    ...
    tunnelOptions: {
        username: 'asos_cpt',
        accessKey: '0a08f159-91e7-40a0-ba08-9c9e2cb3d4ea'
    },

    // tunnel: 'BrowserStackTunnel',

    // tunnelOptions: {
    //     username: 'liwenzhang1',
    //     accessKey: 'Zbw5o1quCRxNgofnoLA4'
    // },
	  ...
	  suites: ['tests/specs-AMD-intern-unit/setup'],
    
	  // Functional test suite(s) to execute against each browser once unit tests are completed
	  functionalSuites: ['tests/specs-AMD-intern-functional/index'],
